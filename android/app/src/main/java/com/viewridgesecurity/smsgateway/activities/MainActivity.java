package com.viewridgesecurity.smsgateway.activities;
...
import com.viewridgesecurity.smsgateway.activities.SMSFilterActivity;
...
import com.viewridgesecurity.smsgateway.BuildConfig;
import com.viewridgesecurity.smsgateway.TextbeeUtils;
...
import com.viewridgesecurity.smsgateway.dtos.SimInfoCollectionDTO;
import com.viewridgesecurity.smsgateway.helpers.SharedPreferenceHelper;
import com.viewridgesecurity.smsgateway.helpers.VersionTracker;
...
//        TextbeeUtils.startStickyNotificationService(mContext);
        ...
        tryNewUIBtn.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(MainActivity.this, com.viewridgesecurity.smsgateway.ui.splash.SplashActivity.class);
